...
namespace JadeEngine
{
  ...
  void FTC::Rebuild()
  {
    ...
    {
      _texts[i - 1]->transform->Attach(_texts[i]->transform, kZeroVector2D_i32, { kTransformBorderCoordinate_right_bottom, kTransformBorderCoordinate_right_bottom }, {kTransformBorderCoordinate_left_top, kTransformBorderCoordinate_right_bottom});
    }
