...
namespace JadeEngine
{
  ...
  All game objects created while a scene is active, such as during it's Start() function will be considered part of that scene and will stop being updated and drawn when a new scene is played. Exception to that are objects created with kObjectLayer_persitant_ui ObjectLayer.
